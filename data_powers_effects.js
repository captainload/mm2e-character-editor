...
const POWER_EFFECTS_LIST = [
  ...
  },
  {
    ...
    "options": [
      { "name": "Aging", "cost": 1, "costType": "flat" },
      { "name": "Disease", "cost": 1, "costType": "flat" },
      { "name": "Poison", "cost": 1, "costType": "flat" },
      { "name": "Starvation and Thirst", "cost": 1, "costType": "flat" },
      { "name": "Need for Sleep", "cost": 1, "costType": "flat" },
      { "name": "Environmental Condition (Cold)", "cost": 1, "costType": "flat" },
      { "name": "Environmental Condition (Heat)", "cost": 1, "costType": "flat" },
      { "name": "Environmental Condition (High Pressure)", "cost": 1, "costType": "flat" },
      { "name": "Environmental Condition (Radiation)", "cost": 1, "costType": "flat" },
      { "name": "Environmental Condition (Vacuum)", "cost": 1, "costType": "flat" },
      { "name": "Suffocation (One Type)", "cost": 1, "costType": "flat" },
      { "name": "Suffocation (All / No need to breathe)", "cost": 2, "costType": "flat" },
      { "name": "Critical Hits", "cost": 2, "costType": "flat" },
      { "name": "Rare Descriptor", "cost": 1, "costType": "flat" },
      { "name": "Uncommon Descriptor", "cost": 2, "costType": "flat" },
      { "name": "Common Descriptor", "cost": 5, "costType": "flat" },
      { "name": "Very Common Descriptor", "cost": 10, "costType": "flat" },
      { "name": "Damage Type", "cost": 5, "costType": "flat" },
      { "name": "Alteration Effects", "cost": 5, "costType": "flat" },
      { "name": "Dazzle Effects", "cost": 5, "costType": "flat" },
      { "name": "Emotion Effects", "cost": 5, "costType": "flat" },
      { "name": "Entrapment", "cost": 5, "costType": "flat" },
      { "name": "Fatigue Effects", "cost": 5, "costType": "flat" },
      { "name": "Interaction Skills", "cost": 5, "costType": "flat" },
      { "name": "Trait Effects", "cost": 5, "costType": "flat" },
      { "name": "Life Support", "cost": 9, "costType": "flat" },
      { "name": "Mental Effects", "cost": 10, "costType": "flat" },
      { "name": "All Nonlethal Physical Damage", "cost": 20, "costType": "flat" },
      { "name": "All Lethal Physical Damage", "cost": 20, "costType": "flat" },
      { "name": "All Nonlethal Energy Damage", "cost": 20, "costType": "flat" },
      { "name": "All Lethal Energy Damage", "cost": 20, "costType": "flat" },
      { "name": "All Fortitude Effects", "cost": 30, "costType": "flat" },
      { "name": "All Reflex Effects", "cost": 30, "costType": "flat" },
      { "name": "All Will Effects", "cost": 30, "costType": "flat" },
      { "name": "Custom Immunity", "cost": 1, "costType": "per_rank" }
    ]
  },
  {
    "name": "Insubstantial",
